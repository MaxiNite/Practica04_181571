...
class Productos : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var listview: ListView = findViewById(R.id.lvProductos) as ListView
    ...
    private class AdaptadorProductos:BaseAdapter{
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            var imagen = vista.findViewById(R.id.ivproducto_img) as ImageView
            var nombre = vista.findViewById(R.id.tvproducto_nombre) as TextView
            var desc = vista.findViewById(R.id.tvproducto_desc) as TextView
            var precio = vista.findViewById(R.id.tvproducto_precio) as TextView
